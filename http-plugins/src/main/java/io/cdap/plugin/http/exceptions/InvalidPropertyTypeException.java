...
package io.cdap.plugin.http.exceptions;
...
public class InvalidPropertyTypeException extends RuntimeException {
  ...
  public InvalidPropertyTypeException(String propertyLabel, String value,
    ...
    super(String.format("'%s' is not a value for '%s' property. Allowed values are: '%s'.",
        value, propertyLabel, String.join(", ", allowedValues)));
  }
}
